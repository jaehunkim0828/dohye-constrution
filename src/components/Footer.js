  ...
  return (
    <div id='footer'>
      ...
      <div id='footer-right-container'>
        <div className='footer-subscript' style={{color: "rgb(61, 62, 56)" }}>주소지:  경기 수원 영통구 청명남로 60번길2(영통동,남전빌딩 3층)</div>
        <div className='footer-subscript' style={{color: "rgb(61, 62, 56)" }}>대표전화: 031-202-5200</div>
      </div>
    </div>
  )
}
